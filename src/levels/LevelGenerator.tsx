...
//     characterPosition: { row: number, column: number } | undefined;
//     setCharacterPosition: Dispatch<SetStateAction<{ row: number, column: number } | undefined>>;
// }

const LevelGenerator: FunctionComponent = () => {
    ...
    const LEVEL_NUM_ROWS = 40;
    const LEVEL_NUM_COLS = 40;
    ...
    while (!foundRoom) {
        ...
        if (leafs[randomRoom].room) {
            ...
            setCharacterPosition({ row: randomXInRoom, column: randomYInRoom });
        }
    }
